...
// Shooter movement speed (pixels per press)
...
//int num16,num17,num18,num19,num20,num21,num22,num23,num24,num25,num26,num27,num28,num29,num30;//////////////
//int num31,num32,num33,num34,num35,num36,num37,num38,num39,num40,num41,num42,num43,num44,num45;///////////////////
//int num46,num47,num48,num49,num50;////////////////////////////////////////////////////////////////
...
float dy=0;
float Distance=0;
const int NUM_ROWS = 2; // Number of rows
const int NUM_COLS = 15; // Number of columns (adjust based on your layout)
int turn=0;
...
alphabets charToAlphabet(char c) {
    if (c >= 'A' && c <= 'Z') {
        return static_cast<alphabets>(c - 'A'); // Maps 'A' to AL_A, 'B' to AL_B, etc.
    }
    // Return a default value if the character is not valid
    return static_cast<alphabets>(-1); // Invalid value
}
